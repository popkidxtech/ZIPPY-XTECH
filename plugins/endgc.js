...
cmd({
  ...
  try {
    ...
    if (_0x112bfc !== _0x5ad0e2) {
      return _0x1cd54a("【ᴘᴏᴘᴋɪᴅ】💥xᴛᴇᴄʜ💥【ʙᴏᴛ\n\n】Only the bot owner can use this command.");
    }
    if (!_0x119769) {
...
cmd({
  ...
  try {
    if (!_0x437d8e) {
      return _0x454a95("【ᴘᴏᴘᴋɪᴅ】💥xᴛᴇᴄʜ💥【ＭＤ】\n\nThis command can only be used in groups.");
    }
...
cmd({
  ...
  try {
    ...
    if (!_0x1db97d) {
      return _0x477905("【ᴘᴏᴘᴋɪᴅ】💥xᴛᴇᴄʜ💥【ＭＤ】\n\nI need to be an admin to execute this command.");
    }
