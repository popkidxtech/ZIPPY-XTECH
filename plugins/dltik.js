...
cmd({
  ...
  try {
    ...
    console.error("ᴘᴏᴘᴋɪᴅ Error in TikTok command:", _0x56bda5);
    _0x2303a0("ᴘᴏᴘᴋɪᴅ An error occurred while processing your request. Please try again later.");
  }
});
