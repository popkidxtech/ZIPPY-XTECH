            ...
            try {
              ...
              if (_0x13e7a7) {
                await _0x2193c1.sendMessage(_0x51f5e6, {
                  ...
                  'mimetype': "video/mp4",
                  'fileName': "POPKID | " + _0x5ad7ef.title + ".mp4",
                  'caption': _0x5ad7ef.title + " | *© ⎝⧹ ᴘᴏᴘᴋɪᴅ ⧸⎠*"
                }, {
                  'quoted': _0x50c272
                });
              } else {
