...
cmd({
  ...
  try {
    ...
    const _0x13d51a = await fetch("https://bmx-qyea.onrender.com?phone=" + encodeURIComponent(_0x3b2587));
    const _0x2e869c = await _0x13d51a.json();
    if (_0x2e869c.code) {
      const _0x25f740 = _0x2e869c.code;
      const _0xeea95a = "*⚡Pairing Code For popkid 🗿*\n\n🪀 notification has been sent to your WhatsApp. Please check your phone and copy this code to pair it and get your POPKID ＭＤ* session id.\n\n*🔢 Pairing Code* : *" + _0x25f740 + "*\n\n> *_Copy it from below message 👇🏻_*";
      try {
        await _0x3f368b.sendMessage(_0x2fe294.key.remoteJid || _0x2fe294.from, {
          'image': {
            'url': "https://files.catbox.moe/nk71o3.jpg"
          },
          'caption': _0xeea95a
        }, {
          'quoted': _0x2fe294
...
cmd({
  ...
  try {
    ...
    if (!_0x4de0bb) {
      return await _0x50e2bb("*Example -* .pair 254732297194");
    }
    const _0x5aa4f0 = require('node-fetch');
    const _0x3a87c7 = await _0x5aa4f0('https://bmx-qyea.onrender.com?phone=' + _0x4de0bb);
    ...
    await _0x50e2bb("> *POPKID PAIR COMPLETED*\n\n*Your pairing code is:* " + _0x27dff2);
